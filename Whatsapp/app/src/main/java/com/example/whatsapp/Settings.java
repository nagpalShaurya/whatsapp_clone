    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UpdateAccountSettings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                loadingBar.setMessage("Updating your profile");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data)
    {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE)
        {
            ...
            if (resultCode == RESULT_OK)
            {
                ...
                loadingBar.setMessage("Please wait, uploading profile picture");
                loadingBar.setCanceledOnTouchOutside(false);
                loadingBar.show();
                ...
                uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if(task.isSuccessful())
                        {
                            ...
                            RootRef.child("Users").child(currentUserID).child("image").setValue(url);
                            loadingBar.dismiss();
                           // RetrieveUserInfo();
...
//
//                            final String downloaedUrl = task.getDownloadUrl().toString();
//
//
